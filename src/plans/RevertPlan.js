//Component to display the Revert plan page with carousel sliders of all its modules
      ...
      <div className="category-slider" key={categoryKey}>
        ...
        <Slider {...sliderSettings}>
          ...
          <QuizCard
            ...
            categoryName={label}
            returnPath="/plans/revert" // will always return to this plan once quiz is done
          />
        </Slider>
      </div>
    );
